...
from Bipirate_Algorithm import distance_correlation_dict_gen, get_distance_corr
...
class Star:
    ...
    def get_score(self, label_dict,feature_index, X, Y):
        ...
        if X.shape[1] > 0:
            ...
            #fitness equation
            fitness = (score / (1 + (15*features_selected))) - (0.5*corr_dist_sum)
...
def fit(num_of_samples,num_iter, X, Y):
    ...
    df.to_csv('BH_bipirate_lam15.csv')
...
if __name__ == "__main__":
    ...
    print("\n\n-----without feature selection lambda = 15----- \n\n")
    ...
    #Run with BH
    print("\n\n---with feature selection lambda = 15------\n\n")
