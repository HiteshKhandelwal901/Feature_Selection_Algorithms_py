...
if __name__ == "__main__":
    ...
    print("data = \n", data)
    #Extracting labels in Y
    Y = data[['Beach','Sunset','FallFoliage','Field','Mountain','Urban']]
    #Extracting attributes by removing the labels
    ...
    #uncomment the line below to run with Ch^2 elimination
    ...
    #Runing the algo without BH, Just the random forest CV
