...
def crossover(pop):
    ...
    """
    Function to implement crossover algorithm. We randomly take 2 stars from 
    the population and apply crossover to get 2 new stars. We append this stars 
    to the list and continue till we get the new list of stars with same number
    of stars as the old list
    ...
    while len(new_pop) != len(pop):
        ...
        new_star1 = Star("s" + str(name))
        new_star2 = Star("s" +str(name+1))
