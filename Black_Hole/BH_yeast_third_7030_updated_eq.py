...
class Star:
    ...
    def get_score(self, label_dict, constant1, feature_index, X, Y):
        ...
        if X.shape[1] > 0:
            ...
            fitness = (score / 1+ (0.075 * features_selected)) + term_3_eff 
